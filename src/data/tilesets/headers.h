...
const struct Tileset gTileset_GeneralWithStairs =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_GeneralWithStairs,
    .palettes = gTilesetPalettes_GeneralWithStairs,
    .metatiles = gMetatiles_GeneralWithStairs,
